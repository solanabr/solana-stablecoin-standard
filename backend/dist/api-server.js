...
app.post("/api/mint/request", async (req, res) => {
    try {
        const { stablecoin, recipient, amount, minter, requestId, metadata = {}, } = req.body;
        // Validate inputs
 ...
 */
app.post("/api/burn/request", async (req, res) => {
    try {
 ...
 */
app.get("/api/events/:stablecoin", async (req, res) => {
    try {
 ...
 */
app.get("/api/compliance/blacklist/check/:address", async (req, res) => {
    try {
        const { address } = req.params;
 ...
 */
app.post("/api/compliance/blacklist/add", async (req, res) => {
    try {
 ...
 */
app.post("/api/compliance/blacklist/remove", async (req, res) => {
    try {
 ...
 */
app.get("/api/compliance/audit/:stablecoin", async (req, res) => {
    try {
        const { stablecoin } = req.params;
 ...
 * Emit webhook event
 */
async function emitWebhook(eventType, payload) {
    try {
 ...
 */
app.get("/api/holders/:stablecoin", async (req, res) => {
    try {
        const { stablecoin } = req.params;
 ...
 */
app.get("/api/stats/:stablecoin", async (req, res) => {
    try {
        const { stablecoin } = req.params;
        // Get from database
