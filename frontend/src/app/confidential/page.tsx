      ...
      <div className="p-6 space-y-6">
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => console.log("Configure:", accountAddress)}
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => console.log("Withdraw:", withdrawAmount)}
                className="rounded-lg bg-warning px-4 py-2.5 text-sm font-medium text-black transition-colors hover:bg-warning/80"
              >
                Withdraw
              </button>
            </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() =>
                console.log("Transfer:", { to: transferTo, amount: transferAmount })
              }
              className="rounded-lg bg-accent px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-accent/80"
            >
