...
pub struct ThawTokenAccount<'info> {
    ...
    /// CHECK: PDA validated by seeds. Signs the thaw CPI.
    #[account(
...
pub fn handle_thaw(ctx: Context<ThawTokenAccount>) -> Result<()> {
    // ── EXECUTE CPI: thaw_account ───────────────────────────────────────────
    ...
    emit!(AccountThawed {
        ...
        thawed_by: ctx.accounts.signer.key(),
    });
