...
pub fn execute(config: &CliConfig, args: &UnpauseArgs) -> Result<()> {
    ...
    let ix_data = sss_token::instruction::Unpause {}.data();
    ...
    println!("Program unpaused. Signature: {}", sig);
