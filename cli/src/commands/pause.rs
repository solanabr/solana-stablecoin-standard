...
pub fn execute(config: &CliConfig, args: &PauseArgs) -> Result<()> {
    ...
    let ix_data = sss_token::instruction::Pause {}.data();
    ...
    println!("Program paused. Signature: {}", sig);
